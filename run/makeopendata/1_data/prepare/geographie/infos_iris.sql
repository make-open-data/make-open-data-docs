  ...
  create  table "defaultdb"."prepare"."infos_iris__dbt_tmp"
...
left join "defaultdb"."prepare"."infos_communes" as infos_communes on infos_communes.code_commune = infos_iris.code_commune_2024
  );
