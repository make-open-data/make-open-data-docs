  ...
  create view "defaultdb"."prepare"."demographie_communes__dbt_tmp"
...
with communes as (
    ...
    FROM 
      "defaultdb"."intermediaires"."decoder_demographie"
    GROUP BY
      code_commune_insee
  ),
  aggregated as (
...
-- Prends toutes les colonnes sauf la colonne à considérer, pour donne en paramètre à unpivot
    ...
    from "defaultdb"."intermediaires"."decoder_demographie"
