  ...
  create  table "defaultdb"."prepare"."habitat_communes__dbt_tmp"
...
pivoted as (
    ...
    sum(
      ...
      case
      when valeur = 'residence_principale'
        then poids_du_logement
      else 0
      end
    )
    ...
    sum(
      ...
      case
      when valeur = 'logement_occasionnel'
        then poids_du_logement
      else 0
      end
    )
    ...
    sum(
      ...
      case
      when valeur = 'residence_secondaire'
        then poids_du_logement
      else 0
      end
    )
