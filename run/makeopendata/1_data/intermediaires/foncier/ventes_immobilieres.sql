  ...
  create  table "defaultdb"."intermediaires"."ventes_immobilieres__dbt_tmp"
...
WITH source_dvf AS (
        ...
        select * from "defaultdb"."sources"."dvf_2014"
...
WITH source_dvf AS (
        ...
        select * from "defaultdb"."sources"."dvf_2015"
...
WITH source_dvf AS (
        ...
        select * from "defaultdb"."sources"."dvf_2016"
...
WITH source_dvf AS (
        ...
        select * from "defaultdb"."sources"."dvf_2017"
...
WITH source_dvf AS (
        ...
        select * from "defaultdb"."sources"."dvf_2018"
...
WITH source_dvf AS (
        ...
        select * from "defaultdb"."sources"."dvf_2019"
...
WITH source_dvf AS (
        ...
        select * from "defaultdb"."sources"."dvf_2020"
...
WITH source_dvf AS (
        ...
        select * from "defaultdb"."sources"."dvf_2021"
...
WITH source_dvf AS (
        ...
        select * from "defaultdb"."sources"."dvf_2022"
...
WITH source_dvf AS (
        ...
        select * from "defaultdb"."sources"."dvf_2024"
