  ...
  create  table "defaultdb"."intermediaires"."mutations_foncieres__dbt_tmp"
...
LEFT JOIN
    "defaultdb"."prepare"."infos_communes" as infos_communes on infos_communes.code_commune = bien_principal_dvf.code_commune
  );
